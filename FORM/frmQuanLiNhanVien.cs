    ...
    public partial class frmQuanLiNhanVien : Form
    {
        ...
        private void cmd_taiKhoan_Click(object sender, EventArgs e)
        {
            if (n == 0)
            {
                ...
                panel_taikhoan.Size = new Size(243, 137);
                n = 1;
            }
            else if (n == 1)
            {
        ...
        private void cmd_danhmuc_Click(object sender, EventArgs e)
        {
            if (n == 0)
            {
                ...
                panel_danhmuc.Size = new Size(243, 157);
                n = 1;
            }
            else if (n == 1)
            {
        ...
        private void cmd_chucnag_Click(object sender, EventArgs e)
        {
            if (n == 0)
            {
                ...
                panel_chucnang.Size = new Size(243, 155);
                n = 1;
            }
            else if (n == 1)
            {
        ...
        private void cmd_bcnhanvien_Click(object sender, EventArgs e)
        {
        ...
        private void menuStrip1_MouseCaptureChanged(object sender, EventArgs e)
        {
        ...
        private void cmd_trogiup_Click(object sender, EventArgs e)
        {
